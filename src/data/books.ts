...
export const bookData: Book[] = [
  ...
  // Third Grade Books
  {
    title: "Catching The Moon: The Story of a Young Girl's Baseball Dreams",
...
export const grades = ["Kindergarten", "First Grade", "Second Grade", "Third Grade", "Fourth Grade", "Fifth Grade"];
